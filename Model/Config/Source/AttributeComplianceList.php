...
class AttributeComplianceList extends AttributeList
{
    /** XML path for compliance attribute @var string */
    public const XML_PATH_COMPLIANCE_ATTRIBUTE_GROUP_FILTER = 'CustomVendor_pdp_group_sections/compliance_section/attributes_group';
    ...
    {
        return $this->getEavAttributesCollection(self::XML_PATH_COMPLIANCE_ATTRIBUTE_GROUP_FILTER);
    }
}
