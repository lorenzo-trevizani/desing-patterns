...
class AttributeFeatureList extends AttributeList
{
    /** XML path for feature attribute @var string */
    public const XML_PATH_FEATURE_ATTRIBUTE_GROUP_FILTER = 'CustomVendor_pdp_group_sections/feature_section/attributes_group';
    ...
    {
        return $this->getEavAttributesCollection(self::XML_PATH_FEATURE_ATTRIBUTE_GROUP_FILTER);
    }
}
